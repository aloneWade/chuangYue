...
public class PingAnCase extends BaseDTO {
    ...
    @Excel(name = "逾期天数", orderNum = "54")
    private String overdueDays;
    @Excel(name = "城市", orderNum = "54")
    private String city;
    @Excel(name = "出生日期", orderNum = "54")
    private String birthDate;
    @Excel(name = "帐单地址邮编", orderNum = "54")
    private String billingAddressZipCode;
    @Excel(name = "帐单地址", orderNum = "54")
    private String billingAddress;
    @Excel(name = "直系亲属联系人姓名", orderNum = "54")
    private String immediateFamilyContactName;
    @Excel(name = "直系人与持卡人关系", orderNum = "54")
    private String cardholderRelationship;
    @Excel(name = "直系人电话", orderNum = "54")
    private String directLine;
    @Excel(name = "直系人手机", orderNum = "54")
    private String directLinePhone;
    @Excel(name = "非直系人姓名", orderNum = "54")
    private String nonLinealPersonName;
    @Excel(name = "非直系人电话", orderNum = "54")
    private String nonLinealPersonTelephone;
    @Excel(name = "非直系人手机", orderNum = "54")
    private String nonLinealPersonPhone;
    @Excel(name = "卡持卡人1客户号", orderNum = "54")
    private String cardholder1CustomerNumber;
    @Excel(name = "卡持卡人1姓名", orderNum = "54")
    private String cardholder1Name;
    @Excel(name = "卡持卡人1手机", orderNum = "54")
    private String cardholder1Phone;
    @Excel(name = "卡持卡人1公司电话", orderNum = "54")
    private String cardholder1CompanyTel;
    @Excel(name = "卡持卡人1家庭电话", orderNum = "54")
    private String cardholder1HomeTel;
    @Excel(name = "卡持卡人2客户号", orderNum = "54")
    private String cardholder2CustomerNumber;
    @Excel(name = "卡持卡人2姓名", orderNum = "54")
    private String cardholder2Name;
    @Excel(name = "卡持卡人2手机", orderNum = "54")
    private String cardholder2Phone;
    @Excel(name = "卡持卡人2公司电话", orderNum = "54")
    private String cardholder2CompanyTel;
    @Excel(name = "卡持卡人2家庭电话", orderNum = "54")
    private String cardholder2HomeTel;
    @Excel(name = "卡持卡人3客户号", orderNum = "54")
    private String cardholder3CustomerNumber;
    @Excel(name = "卡持卡人3姓名", orderNum = "54")
    private String cardholder3Name;
    @Excel(name = "卡持卡人3手机", orderNum = "54")
    private String cardholder3Phone;
    @Excel(name = "卡持卡人3公司电话", orderNum = "54")
    private String cardholder3CompanyTel;
    @Excel(name = "卡持卡人3家庭电话", orderNum = "54")
    private String cardholder3HomeTel;
    @Excel(name = "卡持卡人4客户号", orderNum = "54")
    private String cardholder4CustomerNumber;
    @Excel(name = "卡持卡人4姓名", orderNum = "54")
    private String cardholder4Name;
    @Excel(name = "卡持卡人4手机", orderNum = "54")
    private String cardholder4Phone;
    @Excel(name = "卡持卡人4公司电话", orderNum = "54")
    private String cardholder4CompanyTel;
    @Excel(name = "卡持卡人4家庭电话", orderNum = "54")
    private String cardholder4HomeTel;
    @Excel(name = "卡持卡人5客户号", orderNum = "54")
    private String cardholder5CustomerNumber;
    @Excel(name = "卡持卡人5姓名", orderNum = "54")
    private String cardholder5Name;
    @Excel(name = "卡持卡人5手机", orderNum = "54")
    private String cardholder5Phone;
    @Excel(name = "卡持卡人5公司电话", orderNum = "54")
    private String cardholder5CompanyTel;
    @Excel(name = "卡持卡人5家庭电话", orderNum = "54")
    private String cardholder5HomeTel;
    @Excel(name = "卡持卡人6客户号", orderNum = "54")
    private String cardholder6CustomerNumber;
    @Excel(name = "卡持卡人6姓名", orderNum = "54")
    private String cardholder6Name;
    @Excel(name = "卡持卡人6手机", orderNum = "54")
    private String cardholder6Phone;
    @Excel(name = "卡持卡人6公司电话", orderNum = "54")
    private String cardholder6CompanyTel;
    @Excel(name = "卡持卡人6家庭电话", orderNum = "54")
    private String cardholder6HomeTel;
    @Excel(name = "卡持卡人7客户号", orderNum = "54")
    private String cardholder7CustomerNumber;
    @Excel(name = "卡持卡人7姓名", orderNum = "54")
    private String cardholder7Name;
    @Excel(name = "卡持卡人7手机", orderNum = "54")
    private String cardholder7Phone;
    @Excel(name = "卡持卡人7公司电话", orderNum = "54")
    private String cardholder7CompanyTel;
    @Excel(name = "卡持卡人7家庭电话", orderNum = "54")
    private String cardholder7HomeTel;
    @Excel(name = "卡持卡人8客户号", orderNum = "54")
    private String cardholder8CustomerNumber;
    @Excel(name = "卡持卡人8姓名", orderNum = "54")
    private String cardholder8Name;
    @Excel(name = "卡持卡人8手机", orderNum = "54")
    private String cardholder8Phone;
    @Excel(name = "卡持卡人8公司电话", orderNum = "54")
    private String cardholder8CompanyTel;
    @Excel(name = "卡持卡人8家庭电话", orderNum = "54")
    private String cardholder8HomeTel;
    @Excel(name = "特殊案件类型", orderNum = "54")
    private String specialCaseType;
    @Excel(name = "特殊案件备注", orderNum = "54")
    private String specialCaseRemark;
    @Excel(name = "联系方式", orderNum = "54")
    private String contact;
    @Excel(name = "户籍地址邮编", orderNum = "54")
    private String householdAddressZipCode;
    @Excel(name = "户籍地址", orderNum = "54")
    private String householdAddress;
    @Excel(name = "新增地址", orderNum = "54")
    private String newAddress;
    @Excel(name = "敏感客群", orderNum = "54")
    private String sensitiveCustomers;
    @Excel(name = "手别代码", orderNum = "54")
    private String collectionPhaseCode;
    @Excel(name = "备注1", orderNum = "54")
    private String remark1;
    @Excel(name = "备注2", orderNum = "54")
    private String remark2;
    @Excel(name = "备注3", orderNum = "54")
    private String remark3;
    @Excel(name = "备注4", orderNum = "54")
    private String remark4;
    @Excel(name = "备注5", orderNum = "54")
    private String remark5;
    @Excel(name = "备注6", orderNum = "54")
    private String remark6;
    @Excel(name = "备注7", orderNum = "54")
    private String remark7;
    @Excel(name = "备注8", orderNum = "54")
    private String remark8;
    @Excel(name = "备注9", orderNum = "54")
    private String remark9;
    @Excel(name = "备注10", orderNum = "54")
    private String remark10;
    @Excel(name = "方案1还款额", orderNum = "54")
    private String reimbursementOption1;
    @Excel(name = "方案1减免额", orderNum = "54")
    private String reductionOption1;
    @Excel(name = "方案2还款额", orderNum = "54")
    private String reimbursementOption2;
    @Excel(name = "方案2减免额", orderNum = "54")
    private String reductionOption2;
    @Excel(name = "方案3还款额", orderNum = "54")
    private String reimbursementOption3;
    @Excel(name = "方案3减免额", orderNum = "54")
    private String reductionOption3;
    @Excel(name = "付款起始日", orderNum = "54")
    private String paymentStartDate;
    @Excel(name = "是否免材料", orderNum = "54")
    private String whetherFreeMaterials;
    @Excel(name = "委托起始日", orderNum = "54")
    private String commissioningStartDate;
    @Excel(name = "委托截止日", orderNum = "54")
    private String delegationDeadline;
    @Excel(name = "观测", orderNum = "54")
    private String observation;
    @Excel(name = "债务类型", orderNum = "54")
    private String debtType;
    @Excel(name = "最近24个月逾期情况", orderNum = "54")
    private String last24MonthsOverdue;
    @Excel(name = "人民币可用额度", orderNum = "54")
    private String availableQuotRMB;
    @Excel(name = "美元可用额度", orderNum = "54")
    private String availableQuotDollar;
    @Excel(name = "申请延期次数", orderNum = "54")
    private String extensionNumberApplications;
    @Excel(name = "特殊地区判定", orderNum = "54")
    private String specialAreaDetermination;
    @Excel(name = "是否存在分期未入账", orderNum = "54")
    private String unrecordedInstalment;
    @Excel(name = "证件类型", orderNum = "54")
    private String documentType;
    @Excel(name = "QQ", orderNum = "54")
    private String qq;
    @Excel(name = "省份", orderNum = "54")
    private String provinces1;
    @Excel(name = "城市", orderNum = "54")
    private String city1;
    @Excel(name = "区县", orderNum = "54")
    private String county;
    @Excel(name = "币种", orderNum = "54")
    private String currency;
    @Excel(name = "是否主副卡", orderNum = "54")
    private String primaryOrSecondaryCard;
    @Excel(name = "副卡卡人", orderNum = "54")
    private String deputyCardPeople;
    @Excel(name = "催收员ID", orderNum = "54")
    private String collectionMemberId;
    @Excel(name = "对账单地址", orderNum = "54")
    private String statementAddress;
    @Excel(name = "对账单邮编", orderNum = "54")
    private String statementZipCode;
    @Excel(name = "档案号", orderNum = "54")
    private String fileNo;
    @Excel(name = "账号", orderNum = "54")
    private String account;
    @Excel(name = "逾期日", orderNum = "54")
    private String limitDate;
    @Excel(name = "逾期期数", orderNum = "54")
    private String limitPeriods;
    @Excel(name = "逾期天数", orderNum = "54")
    private String limitDays;
    @Excel(name = "禁止减免", orderNum = "54")
    private String banBreaks;
    @Excel(name = "超限标识", orderNum = "54")
    private String transfiniteLogo;
    @Excel(name = "六个月内作过分期", orderNum = "54")
